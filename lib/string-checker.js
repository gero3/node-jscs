...
StringChecker.prototype = {
    ...
    configure: function(config) {
        ...
        var activeFormattingRules = this._activeFormattingRules;
        ...
        this._rules.forEach(function(rule) {
            ...
            if (config.hasOwnProperty(ruleOptionName)) {
                ...
                if (rule.format) {
                    activeFormattingRules.push(rule);
                }
    ...
    formatString: function(str, filename) {
        ...
        do {
            ...
            //console.log(errors.getErrorList())
            fs.writeFileSync('build-' + retryCount + '.js',str);
